...
typedef struct {
	...
	// Certificate and private key (optional). If both are set, libdatachannel will use them for DTLS.
	// Either pass a file path OR pass the PEM contents directly (if it contains "BEGIN CERTIFICATE").
